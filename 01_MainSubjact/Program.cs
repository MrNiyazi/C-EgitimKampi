...
namespace _01_MainSubjact
{
	internal class Program
	{
		static void Main(string[] args)
		{
			...
			//Console.WriteLine("Email:" + customerPhone);
			...
			//Console.WriteLine("----------Limoata:" + lemondePrice + "₺");
			...
			//TotalPrice = (hamburgerCount * hamburgerPrice) + (cokeCount*cokePrice) +(waterCount*waterPrice) +(friesCount*friesPrice);
			//Console.WriteLine("--------------------------------------------------------");
